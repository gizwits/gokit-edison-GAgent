...
extern int GAgent_Socket_sendto(int sockfd, u8 *data, int len, void *addr, int addr_size);
extern int GAgent_Socket_accept(int sockfd, void *addr, int *addr_size);
extern int GAgent_Socket_recvfrom(int sockfd, u8 *buffer, int len, void *addr, int *addr_size);
